...
public class SubgraphIsomorphism {
    ...
    public SubgraphIsomorphism(List<MyNode> queryNodes, Query queryGraph, GraphDatabaseService database) {
        this.queryNodes = queryNodes;
        this.queryGraph = queryGraph;
        this.database = database;
    }
/*
    public void findIsomorphicSubgraphs(List<NecNode> orderedNecNodeList, List<CandidateRegion> candidateRegionList, Query queryGraph) {
        NecNode necNode = orderedNecNodeList.get(orderCount);
        List<Node> candidateDataVertex = candidateRegionList.
